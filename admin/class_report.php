...
$years_query = "SELECT DISTINCT YEAR FROM MIS_CLASS_COLLECTION ORDER BY YEAR DESC";
...
$sql = "SELECT * FROM MIS_CLASS_COLLECTION WHERE 1=1";
                ...
                <div class="input-group-append">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #8468F4;;">
                            ...
                            <h6 class=" text-center m-4" style="color: white; font-weight: bold;"> Collection Report</h6>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="color: black!important;">
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <?php echo $user_row[$i]['CLASS_NAME'] ?>
