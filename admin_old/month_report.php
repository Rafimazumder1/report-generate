...
if (!empty($search_month)) {
    oci_bind_by_name($parse, ':search_month', $search_month);
}
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-6">
                            <form method="GET" action="">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="search_month" placeholder="Enter Month (e.g., January)" value="<?php echo htmlspecialchars($search_month); ?>">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3" style="background-color: #8468F4;;">
                            ...
                            <h6 class=" text-center m-4" style="color: white; font-weight: bold;">Monthly Collection Report</h6>
                                ...
                                <table class="table table-bordered" id="table_id" width="100%" cellspacing="0">
                                    <thead style="color: #212121;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;">RECEIVE_DATE</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="color: black!important;">
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <?php echo $user_row[$i]['RECEIVE_DATE'] ?>
